...
from dead.spotify import get_artist_data, get_top_tracks
# ----------------------------------------------
...
JTC_VC_ID = [1335479611697660005, 1336105768306348175, 1292159828717994099, 1269338723359916085, 1342300607284777164]
